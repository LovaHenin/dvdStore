...
public class VenteServiceModel {
    ...
    public VenteServiceModel(Optional<Long> id, LocalDate date, float prix, int quantite, Optional<DvdServiceModel> dvdServiceModel, Optional<ClientServiceModel> clientServiceModel) {
        this.id = id;
        this.date = date;
        this.prix = prix;
        this.quantite = quantite;
